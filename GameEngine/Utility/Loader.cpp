...
namespace UtilityM
{
	...
	Loader::Loader()
	{
		...
		_vaos = new vector<GLuint>;
		_vbos = new vector<GLuint>;
		_textures = new vector<GLuint>;
	}
	...
	ModelM::ModelMesh* Loader::loadToVao
	(
	...
	)
	{
		...
		mesh = new ModelM::ModelMesh{ vaoID, indices->size() };
		unbindVAO();
		return mesh;
	}
