...
namespace RenderM
{
	...
	TerrainRenderer::TerrainRenderer(ShaderM::TerrainShader* shader, mat4* projectionMatrix) {
		_shader = shader;
		_shader->start();
	...
	void TerrainRenderer::render(vector<TerrainM::Terrain*>* terrains)
	{
	...
	void TerrainRenderer::prepareTerrain(TerrainM::Terrain* terrain)
	{
		ModelM::ModelMesh* ModelMesh = terrain->mesh();
	...
	void TerrainRenderer::bindTextures(TerrainM::Terrain* terrain)
	{
		TerrainM::TerrainTexturePack* texturePack = terrain->texturePack();
	...
	void TerrainRenderer::loadModelMatrix(TerrainM::Terrain* terrain) {
		glm::mat4* transformationMatrix =
			UtilityM::Maths::createTransformationMatrix(
