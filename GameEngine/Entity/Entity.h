...
namespace EntityM
{
	...
	protected:
		void model(ModelM::Model *model) { _model = model; }
	...
	public:
		Entity();
		Entity(ModelM::Model* model, vec3 position, GLfloat rx, GLfloat ry, GLfloat rz, GLfloat scale);
		~Entity();

		// Getters
		ModelM::Model* model() { return _model; }
